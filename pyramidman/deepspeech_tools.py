...
class DeepSpeechArgs():
    model = "../models/deepspeech/deepspeech-0.6.0-models/output_graph.pbmm"
    lm = "../models/deepspeech/deepspeech-0.6.0-models/lm.binary"
    trie =  "../models/deepspeech/deepspeech-0.6.0-models/trie" 
    beam_width = 500
    lm_alpha = 0.75
    lm_beta = 1.85
...
def transcribe(args, filepath = "audio/2830-3980-0043.wav", verbose = 0):
    ...
    dict_result = dict()
    dict_result["sentence"] = "".join(item.character for item in audio_metadata.items)
